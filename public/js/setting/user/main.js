...
_.tt.tabs({
    ...
    onSelect: function (title, index) {
        if (index === 0) {
            ...
            _.email.textbox({ disabled: true });
            _.password.passwordbox({ disabled: true });
            _.active.switchbutton({ disabled: true, checked: false });
        } else {
            _.btnAdd.linkbutton({ disabled: false });
            // _.btnSave.linkbutton({disabled: true});
...
_.btnAdd.linkbutton({
    ...
    onClick: function () {
        ...
        _.email.textbox({ disabled: false }).textbox("clear");
        _.password.passwordbox({ disabled: false });
        _.active.switchbutton({ disabled: false, checked: false });
    },
});
        ...
        _.ff.form("submit", {
            ...
            success: function (res) {
                try {
                    ...
                    $.messager.alert("Internal Server Error", res, "error");
                }
            },
        });
    },
