...
const PAGE = '{{ url("/") }}';
const REST = '{{ url("/rest") }}';
const RESTMODULE = '{{ route("rest-role.index") }}';
</script>
<script src="{{ asset('js/helper.js') }}"></script>

<script type="module" src="{{ asset('js/setting/role/main.js') }}"></script>
<script type="module" src="{{ asset('js/setting/role/list.js') }}"></script>
<script type="module" src="{{ asset('js/setting/role/form.js') }}"></script>
@endsection

@section('content')
<div id="tt" class="easyui-tabs" style="height: 100%;">
    <div title="List">
        @include('setting.role.list')
    </div>
    <div title="Form">
